function stitch_plot_graph_cg(G, XY, DataSet, gene_names_all, varargin)
% Usage: stitch_plot_graph_cg(G, XY, DataSet, gene_names_all, varargin)
%
% Plots a 2D layout of a coarse-grained STITCH graph.  Nodes and edges are 
% formatted according to optional name/value pairs.  Default behavior 
% colors nodes by sample/timepoint.
% 
% INPUTS:
...
%                  'scaffold': thin, semi-transparent edges with scaffold 
%                   edges highlighed in dark grey (default).
%                  'alpha': thin, semi-transparent edges.
...
parserObj.FunctionName = 'stitch_plot_graph_cg';
