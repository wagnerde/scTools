function plot_scatter_clust(xy, clust_ids, clust_names)
% USAGE: plot_scatter_clust(xy, clust_ids, clust_names)
%
% Generates a simple 2d scatterplot for visualizing cell clusters.
%
% INPUTS:
...
scatter(xy(:,1), xy(:,2), 25, color_ids, 'fill','linewidth',0.0001,'MarkerFaceAlpha',0.8);
